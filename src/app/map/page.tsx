                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                          ...
                          <div style={{ display: 'flex', gap: 6 }}>
                            <SignInButton mode="modal">
                              <button onClick={() => setMenuOpen(false)} style={{ flex: 1, padding: '7px 0', fontSize: 12, fontWeight: 600, borderRadius: 9, border: '1.5px solid #DCE8EE', background: 'white', color: '#1F2D3D', cursor: 'pointer', fontFamily: "'Sora',sans-serif" }}>ログイン</button>
                            </SignInButton>
                            <SignUpButton mode="modal">
                              <button onClick={() => setMenuOpen(false)} style={{ flex: 1, padding: '7px 0', fontSize: 12, fontWeight: 700, borderRadius: 9, border: 'none', background: '#5FAFC6', color: 'white', cursor: 'pointer', fontFamily: "'Sora',sans-serif" }}>新規登録</button>
                            </SignUpButton>
                          </div>
                        </div>
                      )}
              ...
              <div style={{ width: FILTER_W, height: '100%', background: 'rgba(255,255,255,0.96)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', borderRadius: 16, border: '1px solid #DCE8EE', boxShadow: '0 4px 20px rgba(41,88,107,0.10)', display: 'flex', flexDirection: 'column', overflow: 'hidden', animation: filterOpen ? 'panelIn 0.18s ease' : 'none' }}>
                ...
                {mapViewMode === 'scoped' && (
                  <div style={{ padding: '8px 12px', borderTop: '1px solid rgba(95,175,198,0.2)', background: 'rgba(95,175,198,0.05)', flexShrink: 0 }}>
                    <div style={{ fontSize: 11, color: '#5FAFC6', fontWeight: 700, marginBottom: 6, textAlign: 'center', fontFamily: "'Sora',sans-serif" }}>
                      ✦ {scopedLabel} で再配置中
                    </div>
